    ...
    function addNewField() {
        ...
        if (count >= 6) {
            swal({
                ...
                text: "يمكنك إضافة 5 أعضاء كحد أقصى",
                buttons: [null, "موافق"],
            });
        }
        else {
            ...
            if (Corporateaddob != '') {
                ...
                if (Corporateadagemonths <= 6) {
                    ...
                    swal({
                        ...
                        title:"انت رضيع!",
                        buttons: [null, "موافق"],
                        text:"لا يمكنك تسجيل طفل رضيع في الشركات",
                    });
    ...
    $(className + ":last").after(`<div id="dynamic-field-${count}" class="form-group dynamic-field pb-2">
                                   <div class="border-top my-3"></div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="OtherMembersGender${count}" class="form-control selectpicker OtherMembersGender" name="OtherMembersGender${count}" title="حدد العنوان">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-3 form-group ">
                                         ...
                                         <div class="input-group group-form"  style="position:relative">
                                             <input style="z-index: auto;" type="text" name="OtherMembersNationalityBirthdate${count}"  readonly="readonly" id="OtherMembersNationalityBirthdate${count}" class="form-control form-control-custom OtherMembersNationalityBirthdate OtherMembersBirthdateValidation" placeholder="دد-ممم-سسس" autocomplete="off" />
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-4" id="FlieUAE${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500"> الهوية الإماراتية</label> <span class="required">*</span>  <span class="extensionDoc"> (doc, docx, jpeg, jpg, png, pdf)</span>
                                    ...
                                    <div class="col-md-4" id="FliePasport${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500">جواز سفر</label> <span class="required">*</span>  <span class="extensionDoc"> (doc, docx, jpeg, jpg, png, pdf)</span>
                                    ...
                                    <div class="col-md-4" id="FlieTravelID${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500">معرف السفر</label> <span class="required">*</span>  <span class="extensionDoc"> (doc, docx, jpeg, jpg, png, pdf)</span>
                                    ...
                                    <div class="col-md-4" id="FlieSecurityID${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500">معرف الأمان</label>
                                    ...
                                    <div class="col-md-4" id="FlieCompanyID${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500">هوية الشركة</label> <span class="required">*</span>  <span class="extensionDoc"> (doc, docx, jpeg, jpg, png, pdf)</span>
                                    ...
                                    <div class="col-md-4" id="FlieBirthCertificate${count}" style="display:none;">
                                        <div class="form-group">
                                            <label  class="fs-14 text-custom-black fw-500">شهادة الميلاد</label> <span class="required">*</span>  <span class="extensionDoc"> (doc, docx, jpeg, jpg, png, pdf)</span>
