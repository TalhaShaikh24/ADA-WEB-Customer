...
$("#GroupMembersRegistration").click(function (e) {
    ...
    if ($("#RegistrationGroupForms").valid()) {
        ...
        for (var i = 0; i < BirthDateLength; i++) {
            ...
            var DOB = "";
            if (IfArabic) {
                DOB= moment($(".OtherMembersNationalityBirthdate:eq('" + i + "')").val(), 'DD-MMM-YYYY').locale('en').format('DD-MMM-YYYY')
            }
            else {

                DOB= $(".OtherMembersNationalityBirthdate:eq('" + i + "')").val()
            }
        ...
        for (var j = 1; j <= $(className).length; j++) {
          ...
          formData.append("Group", JSON.stringify(DataArr))
           ...
           postRequestWithoutStringfy(ApiUrl+"Register/AddCorporate", formData, function (res) {
...
if (IfArabic) {
    $("#RegistrationGroupForms").validate({
        ...
        messages: {
            ...
            OtherMembersNationalityMobile: "هذه الخانة مطلوبه.",
        ...
        $(className + ":last").after(`<div id="dynamic-field-${count}" class="form-group dynamic-field pb-2">
                                  <div class="border-top my-3"></div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select  Titlekey="Title" id="OtherMembersGender${count}" class="form-control selectpicker OtherMembersGender" name="OtherMembersGender${count}">
                                    ...
                                    <div class="form-group RegisterLang">
                                        ...
                                        <input maxlength="50" type="text" id="OtherMembersName${count}" class="form-control form-control-custom OtherMembersName" name="OtherMembersName${count} " placeholder="الاسم">
                                    </div></div>

                                    <div class="col-md-3">
                                        <div class="form-group RegisterLang">
                                        <label key="Email" class="labelArabic">البريد الإلكتروني</label><span class="text-secondary"> (خياري)</span>
                                        <input maxlength="60" InputKey="Email" type="email" id="OtherMembersEmail${count}" class="form-control form-control-custom OtherMembersEmail uniqueEmail" name="OtherMembersEmail${count}"placeholder="البريد الإلكتروني">
                                    </div></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                         <div class="form-group RegisterLang">
                                            ...
                                            <div class="input-group group-form">
                                                <input style="padding-left: 64px; padding-right: 65px;" Inputkey="Mobile" type="tel" onkeypress="return isNumberKey(event)" id="OtherMembersNationalityMobile${count}" maxlength="9"   class="form-control form-control-custom OtherMembersNationalityMobile uniqueMobile" name="OtherMembersNationalityMobile${count}"placeholder="XXXXXXXXX">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input Inputkey="Passport" type="text" id="OtherMembersNationalityDocument${count}" maxlength="18" class="form-control form-control-custom OtherMembersNationalityDocuments uniquePassport" name="OtherMembersNationalityDocuments${count}" placeholder="رقم الهوية">
                                    </div>
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <select id="OtherMembersNationalityDocumentType${count}" class="form-control selectpicker OtherMembersNationalityDocumentType" name="OtherMembersNationalityDocumentType${count}" data-show-subtext="true" multiple data-live-search="true" title="اختر نوع المستند">
                               ...
                               <div class="row">
                                    ...
                                    <div class="col-md-4" id="FliePasport${count}" style="display:none;">
                                        <div class="form-group">
                                            ...
                                            <input id="InputfilePassport${count}" style=" padding-top: 5px!important;" type="file"  class="form-control form-control-custom DocFile form-control-sm" name="Pdoc${count}" />
                                        </div>
                                    </div>
        ...
        $(className + ":last").after(`<div id="dynamic-field-${count}" class="form-group dynamic-field pb-2">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        ...
                                        <input Inputkey="Passport" type="text" id="OtherMembersNationalityDocument${count}" maxlength="18" class="form-control form-control-custom OtherMembersNationalityDocuments uniquePassport" name="OtherMembersNationalityDocuments${count}" placeholder="ID">
                                    </div>
                                    </div>
